...
## List of Files
- README.md          -- this file.
- BHC_WriteUp.md     -- Description (with examples) of techniques used in this project and final project
  		     	code.
...
- ./final_run        -- Directory of images used to generate final_run video.
- model.py           -- Code that ingests a series of training camera images and trains a neural network 
  		     	to predict the steering angle of the car. 
...
- drive.py           -- Python code that uses model.h5 to predict the steering angle in autonomous mode.
			...
			Speed is controlled to a contant 9 mph.
